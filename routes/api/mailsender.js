...
router.post('/confirm', async (req,res)=>{ 
 ...
 // create reusable transporter object using the default SMTP transport
  var transporter = nodemailer.createTransport({
    host: "az1-ss1.a2hosting.com",
    port:465,
    secure:false,
    auth: {
           user: "parceiros-noreply@nacoesparacristo.org",
           pass: "nacoes2019"
       },  
...
/*   let testAccount = await nodemailer.createTestAccount();
  ...
  let info = await transporter.sendMail({
    from: `"Nações Para Cristo" <${keys.email}>`, // sender address
                            ...
                            <tr>
                                <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                                                                                    ...
                                                                                    <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;" ><!--[if (gte mso 9)|(IE)]>
                                                                                        ...
                                                                                        <div class="column" style="width:100%;max-width:220px;display:inline-block;vertical-align:top;">
                                                                                            <table class="contents" style="border-spacing:0; width:100%"  >
                                                                                                <tr>
                                                                                                    <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0px;" align="left"><a href="#" target="_blank"><img src="http://www.nacoesparacristo.org/public/files/events/logoimage.png" alt="" width="100" height="100" style="border-width:0; max-width:60px;height:auto; display:block" align="left"/></a></td>
                                                                                                </tr>
                                                                                            </table>
                                                                                        </div>
                                                                                        <!--[if (gte mso 9)|(IE)]>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%" bgcolor="#FFFFFF">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width="43%" align="left" valign="top"><font style="font-size:11px; text-decoration:none; color:#474b53; font-family: Verdana, Geneva, sans-serif; text-align:left; line-height:16px; padding-bottom:30px"><a href="#" target="_blank" style="color:#474b53; text-decoration:none">Aceder Nações para Cristo</a></font></td>
                                                                                                            </tr>
                                                                                                        </table></td>
                                                                                                </tr>
                                                                                            </table>
                                    ...
                                    <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5" bgcolor="#FFFFFF">
                                        <tr>
                                            <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#262626; font-size:32px; text-align:left; font-family: Verdana, Geneva, sans-serif">Olá ${req.body.user},</p>
                                                <br style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">
                                              Bem vindo a família das Nações para Cristo. É com enorme satisfação que confirmamos o seu cadastro como parceiro do ministério</br>
                                              Sinta-se em casa. Encontre abaixo os nossos contactos.Nós estamos a sua disposição</br>
                                                <a href="http://www.nacoesparacristo.org/sign-in" target="_blank">
                                        ...
                                        <tr style="margin: 10px">
                                            <td align="center">
                                                <table border="0" cellpadding="0" cellspacing="0" style="Margin:20 auto;">
                                                    <tr>
                                                        <td width="250" height="60" align="center" bgcolor="#008CBA" style="-moz-border-radius: 30px; -webkit-border-radius: 10px; border-radius: 10px;">
                                                            <a target="_blank" href="http://www.nacoesparacristo.org/sign-in style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px;padding-bottom: 15px; font-family: Arial, sans-serif;text-decoration: none; color: #ffffff;" >Aceder a minha conta
                                                ...
                                                <div class="column" style="width:100%;max-width:399px;display:inline-block;vertical-align:top;">
                                                    <table class="contents" style="border-spacing:0; width:100%">
                                                        <tr>
                                                            ...
                                                            <td width="61%" align="left" valign="middle" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><p style="color:#787777; font-size:13px; text-align:left; font-family: Verdana, Geneva, sans-serif"> Igreja Ministerial Nações para Cristo<br />
                                                                   Boane KM 16, Maputo Moçambique<br />
                                                                    http://www.nacoesparacristo.org</p></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                                <!--[if (gte mso 9)|(IE)]>
